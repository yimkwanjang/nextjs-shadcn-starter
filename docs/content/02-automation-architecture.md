...
> 상태: **Draft** — 11절 열린 질문이 확정되면 PRD로 승격한다.
> 작성일: 2026-08-31
...
2. `PROOF` 단계의 `visual.humanRequired`는 **항상 `true`**. 리뷰·인증·판매량을
   AI가 지어내면 그건 자동화가 아니라 허위광고다(12절 참조).
...
| Q-10 | **영상 트랙과 블로그 트랙 중 무엇을 먼저 굴리는가?** | 8절 순서. 블로그가 더 싸고 빠르지만 성과 확인에 2주 필요 |
